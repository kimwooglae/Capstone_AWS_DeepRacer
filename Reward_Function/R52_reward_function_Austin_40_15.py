...
class Reward:
    ...
    def reward_function(self, params):
        ...
        racing_track = [[-8.71807, -1.36264, 3.37299, 0.08689],
                        ...
                        [-5.54899, -3.64617, 4.0, 0.05549],
                        [-5.38065, -3.4938, 4.0, 0.05676],
                        [-5.20459, -3.34385, 4.0, 0.05782],
                        [-5.02511, -3.19876, 4.0, 0.0577],
                        [-4.84287, -3.05798, 4.0, 0.05757],
                        [-4.65836, -2.92102, 4.0, 0.05745],
                        [-4.47192, -2.78744, 4.0, 0.05734],
                        [-4.28388, -2.65682, 4.0, 0.05724],
                        [-4.09442, -2.52891, 4.0, 0.05715],
                        [-3.9037, -2.4035, 4.0, 0.05707],
                        [-3.71178, -2.2805, 4.0, 0.05699],
                        [-3.51874, -2.15983, 4.0, 0.05691],
                        [-3.32464, -2.04141, 4.0, 0.05684],
                        [-3.1295, -1.92523, 4.0, 0.05678],
                        [-2.93333, -1.81136, 4.0, 0.05671],
                        [-2.73604, -1.70002, 4.0, 0.05663],
                        [-2.53751, -1.59157, 4.0, 0.05655],
                        [-2.33758, -1.48652, 4.0, 0.05646],
                        ...
                        [0.62315, -0.68291, 4.0, 0.05615],
                        [0.84829, -0.71925, 4.0, 0.05701],
                        [1.07568, -0.76447, 4.0, 0.05796],
                        [1.30542, -0.81743, 4.0, 0.05894],
                        [1.53759, -0.87727, 4.0, 0.05994],
                        [1.77223, -0.94317, 4.0, 0.06093],
                        [2.00937, -1.01445, 4.0, 0.06191],
                        [2.24896, -1.09042, 4.0, 0.06284],
                        [2.49091, -1.17049, 4.0, 0.06372],
                        [2.76506, -1.25738, 4.0, 0.0719],
                        [3.0393, -1.34015, 4.0, 0.07162],
                        [3.31365, -1.41854, 4.0, 0.07133],
                        [3.58809, -1.49226, 4.0, 0.07104],
                        [3.86263, -1.56085, 4.0, 0.07074],
                        [4.13726, -1.62387, 4.0, 0.07044],
                        [4.41197, -1.68042, 4.0, 0.07012],
                        [4.68675, -1.72946, 4.0, 0.06978],
                        [4.96154, -1.76946, 4.0, 0.06942],
                        [5.23624, -1.79863, 4.0, 0.06906],
                        [5.51061, -1.814, 4.0, 0.0687],
                        [5.78397, -1.81192, 4.0, 0.06834],
                        ...
                        [8.4203, 1.29173, 4.0, 0.06567],
                        [8.18467, 1.42794, 4.0, 0.06804],
                        [7.93437, 1.55343, 4.0, 0.07],
                        [7.6728, 1.66948, 4.0, 0.07154],
                        [7.40288, 1.77764, 4.0, 0.07269],
                        [7.12706, 1.87955, 4.0, 0.07351],
                        [6.84718, 1.97673, 4.0, 0.07407],
                        [6.56459, 2.07045, 4.0, 0.07443],
                        [6.2804, 2.16196, 4.0, 0.07464],
                        [5.99549, 2.25242, 4.0, 0.07473],
                        [5.71042, 2.34264, 4.0, 0.07475],
                        [5.4254, 2.43297, 4.0, 0.07475],
                        [5.14049, 2.52356, 4.0, 0.07474],
                        [4.85779, 2.61313, 4.0, 0.07414],
                        [4.57696, 2.7014, 4.0, 0.07359],
                        [4.29908, 2.78748, 4.0, 0.07273],
                        [4.02497, 2.87059, 4.0, 0.07161],
                        ...
                        [-10.56815, 2.55083, 4.0, 0.06427],
                        [-10.48831, 2.29621, 4.0, 0.06671],
                        [-10.39102, 2.03849, 4.0, 0.06887],
                        [-10.28007, 1.77885, 4.0, 0.07059],
                        [-10.15918, 1.51807, 4.0, 0.07186],
                        [-10.03181, 1.25661, 4.0, 0.07271],
                        [-9.90113, 0.99471, 4.0, 0.07317],
                        [-9.77002, 0.73266, 4.0, 0.07326],
                        [-9.63916, 0.47048, 4.0, 0.07326],
                        [-9.50822, 0.2083, 4.0, 0.07326],
                        [-9.37711, -0.0538, 4.0, 0.07327],
                        [-9.24579, -0.3158, 4.0, 0.07327],
                        [-9.1142, -0.57767, 4.0, 0.07327],
                        [-8.98238, -0.83943, 4.0, 0.07327],
